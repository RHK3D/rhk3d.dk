    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div class="flex space-x-4">
                ...
                <a href="#" class="text-white text-sm font-medium">Lokal tid: <span class="font-normal">12:34</span></a>
                <a href="#" class="text-white text-sm font-medium">Lokation: <span class="font-normal">Skanderborg, DK</span></a>
                <a href="#" class="text-white text-sm font-medium">Projects</a>
                <a href="#" class="text-white text-sm font-medium">Calendar</a>
            </div>
            </div>
        </div>
